...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        methods.add(getMethod(pageClass, "before"));
        methods.add(getMethod(pageClass, route.getAction()));
        methods.add(getMethod(pageClass, "after"));
        ...
        try {
            ...
            throw new ServletException("Unable to run action [pageClass=" + pageClass + ", method=" + lastMethod + "].", e);
        ...
        try {
            ...
            throw new ServletException("Can't render template [pageClass=" + pageClass + ", method=" + lastMethod + "].", e);
        }
    }
